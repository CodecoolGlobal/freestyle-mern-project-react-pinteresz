    ...
    return(
        <div className='HeroComponent'>
            ...
            <div className='introduction'>
                ...
                but be careful, the more hints you ask for, the less points you get.<br></br><br></br>
                Once you guess the movie, you will recieve some points that will give you a rank on our leaderboard.
                In the future you will also be able to spend these points on perks, that will make your job easier.<br></br><br></br>
